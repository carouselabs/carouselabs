...
// Persistent nudge for a FREE-plan user who has used their one lifetime
// post — shown on every page until they upgrade (see app/(app)/layout.tsx,
// which computes `show` server-side from the same Subscription fields
// lib/credits.ts's availableCredits() uses to gate generation itself).
//
...
// creditsUsed >= FREE_LIFETIME_POSTS) actually changed, i.e. they upgraded.
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-2.5 bg-[rgba(217,119,6,0.1)] border-b border-[rgba(217,119,6,0.3)] text-[13px] text-[#0A0A0A]">
      ...
      <p className="flex-1 min-w-0 font-medium">
        You&apos;ve used your free post! Upgrade to Pro or Growth to keep creating.
      </p>
      <Link
