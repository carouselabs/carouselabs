...
// amounts are in cents. The Pro subscription is a $34/month plan that must be
// created in the Razorpay dashboard (amount 3400, currency USD) with its id set
...
export const PRO_MONTHLY_PRICE_CENTS = 3400 // $34 / month
